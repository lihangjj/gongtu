...
import lz.util.regex.RegexUtil;
...
@Controller
public class CheckRandAndCode extends AbstractController{
    @Autowired
    ...
    boolean checkRandAndCode(HttpServletRequest request) {
        ...
        return code.equalsIgnoreCase((String) request.getSession().getAttribute("rand"));
    }
    ...
    public void defaultKaptcha(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
        ...
        try {
            ...
            httpServletRequest.getSession().setAttribute("rand", createText);
