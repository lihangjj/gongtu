...
import lz.realm.CustomerCredentialsMatcher;
import lz.realm.MemberRealm;
...
public class ShiroConfig {
    ...
    public RememberMeManager getRememberManager() { // 5
        ...
        SimpleCookie cookie = new SimpleCookie("LZ-RememberMe");
    ...
    public DefaultWebSessionManager getSessionManager(SessionDAO sessionDAO,
        ...
        SimpleCookie sessionIdCookie = new SimpleCookie("lz-session-id");
    ...
    public FormAuthenticationFilter getLoginFilter() { // 在ShiroFilterFactoryBean中使用
        ...
        filter.setLoginUrl("/loginPage");    // 没有登陆过，就去登陆页面
    ...
    public LogoutFilter getLogoutFilter() { // 在ShiroFilterFactoryBean中使用
        ...
        logoutFilter.setRedirectUrl("/logoutMy");    // 首页路径，登录注销后回到的页面
        return logoutFilter;
    }
